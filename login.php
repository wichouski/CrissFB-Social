...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['login'])) {
    ...
    $stmt = $conn->prepare("SELECT id, usuario FROM login WHERE usuario = ? AND contrasena = ?");
    ...
    if ($result->num_rows > 0) {
        ...
        $_SESSION['usuario'] = $row['usuario']; // Guarda el nombre del usuario para usar en otras páginas
...
<body>
    <div class="login-container">
        ...
        <img src="resources/buttons/logo con letra.gif" alt="Animación GIF" width="275" height="140">
